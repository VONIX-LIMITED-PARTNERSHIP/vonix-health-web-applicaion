...
const en: Dictionary = {
  common: {
    ...
    guest_assessment_disclaimer_2: "The results are based on your self-reported answers and may not be accurate.",
    ...
    guest_assessment_disclaimer_4:
      "Your data will be used anonymously for improving the assessment and will not be linked to your personal identity.",
