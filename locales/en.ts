const en = {
  ...
  landing: {
    hero_badge: "AI-Powered Healthcare Enhancement",
    hero_title_line1: "Health for",
    hero_title_line2: "Everyone",
    hero_subtitle: "Take Control of Your Health",
    hero_description: "VONIX combines AI, Blockchain, and Precision Medicine to elevate your healthcare experience in a secure and personalized digital era.",
    cta_assessment: "Try Mental Health Assessment",

    future_title: "Step into the Future of Digital Health with Us",
    future_desc: "VONIX is a healthcare platform that uses AI to analyze and monitor your health, focusing on security and personalization.",
    feature_accessible_title: "Accessible",
    feature_accessible_desc: "Manage your health anywhere, anytime on your mobile.",
    feature_secure_title: "Secure",
    feature_secure_desc: "Protect your health data with blockchain technology.",
    feature_comprehensive_title: "Comprehensive",
    feature_comprehensive_desc: "Complete and accurate information.",

    solutions_title: "Our Core Solutions",
    solutions_subtitle: "Healthcare solutions designed for you.",
    solution_ai_title: "AI Health Assessment",
    solution_ai_desc: "Preliminary health assessment with accurate and fast AI, providing personalized health care advice.",
    solution_hospital_title: "Hospital Connection",
    solution_hospital_desc: "Instantly transfer treatment and diagnosis information to network hospitals.",
    solution_records_title: "Immutable Health Records",
    solution_records_desc: "Store your health data securely on the blockchain.",
    solution_privacy_title: "Privacy & Design Rights",
    solution_privacy_desc: "A platform that lets you truly own your health data and give consent according to PDPA correctly.",

    why_title: "Why VONIX Stands Out",
    why_subtitle: "The difference that combines technology and holistic health care.",
    why_security_title: "Security & Privacy",
    why_security_desc: "High-level security standards with Blockchain.",
    why_ai_title: "AI Insights Analysis",
    why_ai_desc: "Use AI to analyze and predict health issues accurately.",
    why_person_title: "Person-Centric",
    why_person_desc: "Customize health care to fit your lifestyle.",
    why_access_title: "Access & Care",
    why_access_desc: "Connect with health experts and telemedicine.",

    impact_title: "Our Social Impact and Value",
    impact_desc: "VONIX is committed to driving society towards accessible and equitable healthcare via digital services.",
    impact_community_title: "Elevating Community Health",
    impact_community_desc: "Raising awareness and helping communities access quality healthcare thoroughly.",
    impact_sustainability_title: "Health & Social Sustainability",
    impact_sustainability_desc: "Helping reduce public health costs and creating a sustainably healthy society for the future.",
    impact_tech_title: "Supporting HealthTech",
    impact_tech_desc: "Promoting investment and entrepreneurs in Health Tech and medical technology.",

    collab_title: "Strategic Collaboration",
    collab_desc: "We are open to all business opportunities and ready to move forward with innovation together with you.",
    collab_health_title: "Healthcare Institutions",
    collab_health_desc: "Collaborating with hospitals and clinics to elevate medical services.",
    collab_gov_title: "Government Agencies",
    collab_gov_desc: "Pushing policies and health services for government and public organizations.",
    collab_startup_title: "Startups & Tech",
    collab_startup_desc: "Working with other technology projects to develop health solutions.",

    cta_footer_title: "Ready to Join Us?",
    cta_footer_desc: "Start taking care of your health and your loved ones today with an AI system that cares for you like a personal expert 24/7.",
    cta_footer_button: "Try It Free",
  }
} as const
