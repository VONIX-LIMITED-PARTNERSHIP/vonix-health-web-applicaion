...
const en: Dictionary = {
  common: {
    ...
    guest_assessment_disclaimer_title: "Important Disclaimer",
    guest_assessment_disclaimer_1:
      "This assessment is for informational purposes only and does not constitute medical advice.",
    guest_assessment_disclaimer_2:
      "The results are generated by AI and should not be used for self-diagnosis or treatment.",
    ...
    guest_assessment_disclaimer_4:
      "Your answers are not saved to our database and are used only for immediate analysis.",
    i_understand_disclaimer: "I understand and agree to the disclaimer.",
    ...
    this_data_not_saved: "This data is not saved to your profile.",
    ...
    no_significant_risk_factors: "No significant risk factors identified.",
    your_health_normal: "Your health appears to be within normal parameters.",
    no_additional_recommendations: "No additional recommendations at this time.",
    your_health_excellent: "Your health appears to be excellent!",
    want_to_save_results: "Want to save your results and track progress?",
    login_to_track_progress:
      "Log in or register to save your assessment results, track your health journey, and get personalized insights over time.",
    ...
    privacy_policy_intro:
      "Vonix Limited Partnership values the protection of your personal data. This privacy policy explains our practices regarding the collection, use, or disclosure of personal data, as well as the various rights of personal data owners.",
    ...
    data_rights: "8. Rights of Personal Data Owners",
    ...
    not_logged_in: "You must be logged in to save this assessment.",
    ...
    consult_doctor_modal_description: "Prepare your health information to consult with medical experts",
    step_1_prepare_data: "Prepare Health Data",
    step_1_prepare_data_desc: "Gather your health assessment results and related information",
    step_2_add_details: "Add Symptom Details",
    step_2_add_details_desc: "Describe additional symptoms or concerns you want to discuss",
  ...
  assessment: {
    ...
    not_logged_in: "You need to be logged in to save your assessment.",
    save_failed: "Failed to save assessment: {{message}}",
    ai_analyzing_results: "AI is analyzing your results...",
    ai_analyzing_description:
      "Please wait a moment while our AI processes your assessment data to provide personalized insights.",
    ...
    error: "Error",
    no_guest_assessment_data: "No guest assessment data found. Please complete the assessment first.",
    error_loading_analysis: "Error loading AI analysis.",
    no_data: "No data found.",
    low_risk: "Low Risk",
    medium_risk: "Medium Risk",
    high_risk: "High Risk",
    very_high_risk: "Very High Risk",
    unspecified_risk: "Unspecified Risk",
    overall_risk_level: "Overall Risk Level",
    questions_answered: "Questions Answered",
    risk_factors: "Risk Factors",
    recommendations: "Recommendations",
    ...
    ai_summary: "AI Summary",
    no_significant_risk_factors: "No significant risk factors identified.",
    your_health_normal: "Your health appears to be normal.",
    no_additional_recommendations: "No additional recommendations at this time.",
    your_health_excellent: "Your health is excellent!",
    want_to_save_results: "Want to save your results?",
  ...
  placeholder: {
    ...
    specifyOther: "Please specify other",
  },
  validation: {
