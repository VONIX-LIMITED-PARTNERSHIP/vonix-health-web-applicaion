...
const en: Dictionary = {
  common: {
    ...
    health_overview_modal_description: "A comprehensive summary of your health assessments and recommendations.",
    ...
    risk_factors_summary: "Risk Factors",
    items_unit: "items",
    improvement_areas_summary: "Areas for Improvement",
    health_report_summary: "Health Report",
    ready_to_use: "Ready",
    not_ready: "Not Ready",
    requires_3_categories_for_report: "Requires 3+ categories",
