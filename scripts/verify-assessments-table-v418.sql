...
DECLARE
    ...
    rec RECORD;
BEGIN
    RAISE NOTICE '🔍 Starting Assessment Table v418 Verification...';
    RAISE NOTICE '===================================================';
    ...
    FOR rec IN 
        SELECT 
            ...
            CASE 
                ...
                WHEN p.proname LIKE '%statistics%' THEN '📊 Statistics'
    ...
    BEGIN
        PERFORM get_user_assessment_statistics('00000000-0000-0000-0000-000000000000'::UUID);
        RAISE NOTICE '✅ get_user_assessment_statistics: Function works correctly';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE '❌ get_user_assessment_statistics: %', SQLERRM;
    END;
    
    -- Test get_latest_user_assessment_by_category function
    BEGIN
        PERFORM get_latest_user_assessment_by_category('00000000-0000-0000-0000-000000000000'::UUID, NULL, 'basic');
        RAISE NOTICE '✅ get_latest_user_assessment_by_category: Function works correctly';
    EXCEPTION WHEN OTHERS THEN
        RAISE NOTICE '❌ get_latest_user_assessment_by_category: %', SQLERRM;
    END;
    ...
    BEGIN
        ...
        RAISE NOTICE '✅ assessment_summary view: % records available', 
    ...
    RAISE NOTICE '======================================';
    RAISE NOTICE 'The assessments table v418 is ready for use with:';
    RAISE NOTICE '  ✅ Proper structure and constraints';
    RAISE NOTICE '  ✅ Performance indexes (% total)', index_count;
    RAISE NOTICE '  ✅ Security policies (% RLS policies)', policy_count;
    RAISE NOTICE '  ✅ Helper functions (% functions)', function_count;
    RAISE NOTICE '  ✅ Guest and user support';
    RAISE NOTICE '  ✅ Bilingual support';
    RAISE NOTICE '';
    RAISE NOTICE '🔧 NEW FUNCTION NAMES (v418):';
...
-- Show all functions with their exact signatures
SELECT 
