...
-- Create NEW function to get assessment statistics with proper return type
CREATE OR REPLACE FUNCTION get_user_assessment_stats(p_user_id UUID)
RETURNS TABLE (
...
GRANT EXECUTE ON FUNCTION get_user_assessment_stats TO authenticated;
...
BEGIN
    ...
    RAISE NOTICE '  - get_latest_assessment_by_category()';
    RAISE NOTICE '  - get_user_assessment_stats()';
