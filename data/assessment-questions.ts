...
export const assessmentData = {
  th: {
    categories: [
      ...
      // Guest assessment category for Thai
      {
        id: "guest-assessment",
  ...
  en: {
    categories: [
      ...
      // Guest assessment category for English
      {
        id: "guest-assessment",
        title: "Preliminary Health Assessment",
        description: "Try a preliminary health assessment to see results and recommendations",
        icon: "FlaskConical",
        required: false,
        guest: true,
        estimatedTime: 5,
        questions: [
          ...
          },
          {
            ...
            question: "Do you have a family history of heart disease?",
            type: "yes-no",
            description: "e.g., parents, siblings with heart disease",
            required: true,
            category: "guest",
            weight: 3,
          },
...
//  Some older modules still import `guestAssessmentCategory` directly.
//  We expose the Thai version (id = "guest-assessment") to keep those imports
//  working without changing the rest of the codebase.
// -----------------------------------------------------------------------------
export const guestAssessmentCategory = assessmentData.th.categories.find(
  (c) => c.id === "guest-assessment",
...
// Note: This export is kept for compatibility but guest assessment should be fetched via getAssessmentCategories
