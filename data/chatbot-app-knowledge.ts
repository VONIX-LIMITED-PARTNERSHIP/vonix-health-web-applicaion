...
export const appKnowledgeBase: AppKnowledgeEntry[] = [
  ...
  {
    keywords: ["สวัสดี", "หวัดดี", "ดี", "เป็นไงบ้าง"],
    response: `สวัสดีครับ {userName}! 😊
...
มีอะไรสงสัยถามได้เลยครับ! 💚`,
  ...
  {
    keywords: ["ขอบคุณ", "ขอบใจ", "แสงค์"],
    response: `ยินดีครับ {userName}! 😊
...
สามารถถามได้ตลอดเวลานะครับ! ผมพร้อมช่วยเหลือ 24/7 🌟`,
  ...
  {
    keywords: ["เหนื่อย", "ท้อ", "เศร้า", "ไม่ไหว"],
    response: `เข้าใจความรู้สึกของคุณครับ 🤗
...
คุณทำได้แน่นอน! ผมเชื่อในตัวคุณ ✨`,
  ...
  {
    keywords: ["สุขภาพ", "ดูแลตัวเอง", "สุขภาพดี"],
    response: `การดูแลสุขภาพเป็นสิ่งสำคัญครับ {userName}! 💚
