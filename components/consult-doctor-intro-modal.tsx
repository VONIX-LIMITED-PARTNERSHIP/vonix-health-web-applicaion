...
export function ConsultDoctorIntroModal({ isOpen, onOpenChange, onProceed }: ConsultDoctorIntroModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px] rounded-xl shadow-2xl p-6 bg-white dark:bg-gray-900">
        <DialogHeader className="text-center">
          <div className="flex justify-center mb-4">
            <Stethoscope className="h-12 w-12 text-green-600" />
          </div>
          <DialogTitle className="text-2xl font-bold text-gray-800 dark:text-white">
            {t("consult_doctor_modal_title")}
          </DialogTitle>
          <DialogDescription className="text-gray-600 dark:text-gray-300 mt-2">
            {t("consult_doctor_modal_description")}
          </DialogDescription>
        </DialogHeader>
        <div className="py-4 space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white">{t("step_1_prepare_data")}</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">{t("step_1_prepare_data_desc")}</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white">{t("step_2_add_details")}</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">{t("step_2_add_details_desc")}</p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div>
              <h4 className="font-semibold text-gray-800 dark:text-white">{t("step_3_wait_for_contact")}</h4>
              <p className="text-sm text-gray-600 dark:text-gray-300">{t("step_3_wait_for_contact_desc")}</p>
            </div>
          </div>
        </div>
